...
<%if reg="1" then%>
	...
	<form align="center" method="post" name="FrmAddLink" LANGUAGE="javascript"  action="adduser1.asp">
			...
			<TBODY>
				...
				<TR>
					<TD>
						<P> 欢迎您加入【<%=eChSys%>】，【<%=eChSys%>】为新闻发布系统，为维护网上公共秩序和社会稳定，请您自觉遵守以下条款：<br><br>
				...
				<TR>
					<TD  align="center" class="TDtop">
						<INPUT  type=submit value=我同意 name=Submit>
						<INPUT  onclick="javascript:window.close();" type=button value=不同意 name=Submit1>
				  </TD>
				</TR>
			</TBODY>
	  </TABLE>
