					...
					if rst("Purview")<>"99999" or request.cookies(eChsys)("ManagePurview")="99999" then
						response.write "<tr align='center' height=20>"& chr(10)
							...
							if rst("oskey")="super" and rst("purview")=99999 then
								...
								oskey1=rst("oskey")
						         select case oskey1
							      case "super" response.write "系统管理员"
							      case "check" response.write "<a href='AdminManage.asp?oskey="& oskey1 &"'>审核管理员</a>"
								  case "checkdep" response.write "<a href='AdminManage.asp?oskey="& oskey1 &"'>事项审批管理员</a>"
							      case "typemaster" response.write "<a href='AdminManage.asp?oskey="& oskey1 &"'>总栏管理员</a>"
							      case "bigmaster" response.write "<a href='AdminManage.asp?oskey="& oskey1 &"'>大类管理员</a>"
							      case "smallmaster" response.write "<a href='AdminManage.asp?oskey="& oskey1 &"'>小类管理员</a>"
						         end select
							end if
							response.write "</td>"& chr(10)
						...
						response.write "<td align='center' bgcolor='#FFFFFF'>"
							if rst1("oskey")="super" and rst1("purview")="99999" then
								...
								select case oskey2
									...
									case "checkdep" response.write "<a href='AdminManage.asp?oskey="& oskey2 &"'>事项审批用户</a>"
