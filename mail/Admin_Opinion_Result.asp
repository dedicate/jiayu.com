                    ...
                    <td height="300" valign="top">
                      ...
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFDFBF" id="AutoNumber1" style="border-collapse: collapse">	
                        <tr class="TDtop1" align="center">
                          ...
                          <td width="43%"  class="top1">发言标题</td>
                          <td width="12%"  class="top1">发言日期</td>
                        </tr>
                        <%
...
Response.write "<tr><td align=center bgcolor=#FFFFFF colspan=3 height=100><font color=red>对不起，没有找到你要搜索的发言！</font><a href=E_OpinionList.asp>返回</a></td></tr>"
