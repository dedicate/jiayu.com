...
<tr> 
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >言论默认状态：</td>
          <td  colspan="2" align="left" > <select name="reviewcheck" size="1" >
            ...
            </select> <font color=red>包括（公众留言，评论，领导信箱，建议献策 栏目）</font></td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >公众留言菜单中：</td>
		...
		<tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >领导信箱菜单中：</td>
          <td  colspan="2" align="left" > <select name="LeadMailCheckShow" size="1" >
              <option <%if rs9("LeadMailCheckShow")="1" then%>selected<%end if%> value="1">显示</option>
              <option <%if rs9("LeadMailCheckShow")="0" then%>selected<%end if%> value="0">不显示</option>
            </select>
            已审核信件</td>
        </tr>
		<tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >建议献策菜单中：</td>
          <td  colspan="2" align="left" > <select name="OpinionCheckShow" size="1" >
              <option <%if rs9("OpinionCheckShow")="1" then%>selected<%end if%> value="1">显示</option>
              <option <%if rs9("OpinionCheckShow")="0" then%>selected<%end if%> value="0">不显示</option>
            </select>
            已审核建议献策</td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showmove" size="1" >
              ...
              <option <%if rs9("showmove")="0" then%>selected<%end if%> value="0">手动播放</option>
            </select></td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 市长信箱管理：</td>
