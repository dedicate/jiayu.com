...
<div id="Dcard3" class="hackBox">
		...
		<a href="[!--news.url--]dangwugongkai/bumengongzuo/">部门工作</a> |
...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="one">
	...
	<td width="200" height="500" valign="top">
	  <table width="200" height="500" border="0" cellpadding="0" cellspacing="0" background="[!--news.url--]skin/jy/images/lmdh11.gif">
...
<? @sys_ShowClassByTemp(294,24,0,0);?>		
  </table></td>
        </tr>
      </table>	  </td>
	<td width="15"></td>
	<td width="550" height="30" valign="top">
      <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0" background="[!--news.url--]skin/jy/images/wz.gif">
       <tr>
        ...
        <td width="520">您现在的位置：[!--newsnav--]</td>
      </tr>
    </table>
...
<li><span>[!--show.page--]</span></li>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;border:1px solid #FFCC99">
        <tr>
          <td height="50" align="center"><a href="[!--news.url--]dangwugongkai/jicengdangwugongkai/" target="_blank" title="基层党务公开"><img src="[!--news.url--]skin/jy/images/l2.gif" width="168" height="50" border="0" /></a></td>
        </tr>
      </table>

<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;border:1px solid #FFCC99">
        <tr>
          <td height="50" align="center" ><a href="[!--news.url--]dangwugongkai/lianzhengwenhua/" target="_blank" title="廉政文化"><img src="[!--news.url--]skin/jy/images/l1.gif" alt=" " width="168" height="50" border="0" /></a></td>
        </tr>
      </table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;border:1px solid #FFCC99">
        <tr>
          <td height="50" align="center"><a href="http://www.jiayu.gov.cn/bbs/index.asp?boardid=6" target="_blank" title="建言献策"><img src="[!--news.url--]skin/jy/images/l3.gif" width="168" height="50" border="0" /></a></td>
        </tr>
      </table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;border:1px solid #FFCC99">
        <tr>
          <td height="200" align="center"><img src="[!--news.url--]skin/jy/images/by.gif" width="168" height="230" border="0" /></a></td>
        </tr>
      </table>
...
<div class="copyright">
    <table width="980" border="0" cellpadding="0" cellspacing="0">
	  <tr>
	    <td height="30" colspan="2" align="center" background="[!--news.url--]skin/jy/images/foot_nav_bg.gif">&nbsp;|&nbsp;<a href="/">网站首页</a>&nbsp;|&nbsp;
